  ...
  <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-100">
    <div className="max-w-5xl mx-auto px-4 py-4">
      <div className="flex items-center space-x-2 text-xs sm:text-sm">
        <Link to="/fabric-collections" className="flex items-center text-gray-600 hover:text-amber-600 transition group">
        ...
        <span className="text-amber-700 font-semibold truncate">{collection.name}</span>
      </div>
    </div>
  </div>
  ...
  <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-orange-50">
    <div className="relative max-w-5xl mx-auto px-4 py-12 sm:py-16 md:py-20 text-center">
      <div className="inline-flex items-center px-3 py-1.5 bg-white rounded-full shadow-lg border border-amber-200 mb-4 text-xs sm:text-sm">
        ...
        <span className="text-amber-700 font-semibold uppercase tracking-wider">{collection.type}</span>
      </div>
      ...
      <div className="inline-flex items-center px-4 py-2 bg-white rounded-full shadow-lg border border-amber-200 text-xs sm:text-sm">
        ...
        <span>{collection.fabricCount} Premium Fabric Options Available</span>
      </div>
    </div>
    {/* Decorative shapes */}
    ...
    <div className="max-w-5xl mx-auto px-2 sm:px-4 md:px-6">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-4 md:gap-6">
        {fabrics.fabrics.map((fabric, index) => (
          <div
            key={fabric._id}
            className="group relative bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition transform hover:-translate-y-0.5 border border-amber-100"
          ...
          >
            <div className="aspect-square overflow-hidden relative">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <Link
                  ...
                  className="bg-white text-gray-900 px-3 py-1.5 rounded-full opacity-0 group-hover:opacity-100 transition duration-300 transform translate-y-4 group-hover:translate-y-0 flex items-center space-x-1 text-xs sm:text-sm shadow-lg hover:shadow-xl hover:scale-105"
                >
              ...
              <button
                className="absolute top-2 right-2 w-7 h-7 bg-white rounded-full flex items-center justify-center text-gray-400 hover:text-red-500 opacity-0 group-hover:opacity-100 transition transform hover:scale-110 hover:shadow-lg"
            ...
            <div className="p-3 sm:p-4">
              <span className="inline-flex items-center px-2 py-0.5 bg-amber-100 text-amber-700 text-xs font-medium rounded-full mb-2">
                {fabric.color}
              </span>
              <div className="flex justify-between items-center mb-1">
                <h3 className="text-lg font-bold text-gray-900 font-serif group-hover:text-amber-600 transition-colors">
                  {fabric.name}
                </h3>
                <ShoppingCart
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="bg-green-500 hover:bg-green-600 text-white px-3 py-1.5 sm:px-4 sm:py-2 rounded-full transition transform hover:scale-105 shadow-md hover:shadow-lg flex items-center space-x-1 text-xs sm:text-sm"
                >
  ...
  <section className="relative py-8 sm:py-12 md:py-16 bg-gradient-to-b from-white to-amber-50 overflow-hidden text-center">
    <div className="max-w-4xl mx-auto px-4 sm:px-6">
      ...
      <p className="text-base sm:text-lg text-amber-500 mb-6 max-w-md mx-auto leading-relaxed">
        Book a free home consultation to see these exquisite fabrics in your space with our expert guidance.
      </p>
      <Link
        to="/book-demo"
