...
import { ArrowLeft, Eye, Heart, MessageCircle, ShoppingCart, Sparkles, Star } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-b border-amber-100">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center space-x-3 text-sm">
            ...
            <span className="text-amber-700 font-semibold">{collection.name}</span>
          </div>
        </div>
      </div>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 via-white to-orange-50">
        ...
        <div className="absolute bottom-20 right-10 w-32 h-32 bg-gradient-to-br from-orange-200 to-amber-200 rounded-full opacity-20 animate-pulse delay-1000"></div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            {fabrics.fabrics.map((fabric, index) => (
              <div
                key={fabric._id}
                className="group relative bg-white rounded-3xl shadow-xl overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-amber-100"
              ...
              >
                <div className="aspect-square overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <Link
                      ...
                      className="bg-white text-gray-900 px-6 py-3 rounded-full opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-8 group-hover:translate-y-0 flex items-center space-x-2 shadow-2xl hover:shadow-xl hover:scale-105"
                    >
                  ...
                  {/* Heart button */}
                  <button className="absolute top-4 right-4 w-10 h-10 bg-white rounded-full flex items-center justify-center text-gray-400 hover:text-red-500 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-110 opacity-0 group-hover:opacity-100" onClick={() => handleAddToWishlist(fabric)}>
                ...
                <div className="p-8">
                  <div className="flex items-center justify-between mb-4">
                    <span className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-amber-100 to-orange-100 text-amber-700 text-sm font-semibold rounded-full">
                      {fabric.color}
                    </span>
                  </div>
                  
                  <div className="flex justify-between">
                  <h3 className="text-2xl font-bold text-gray-900 mb-3 font-serif group-hover:text-amber-600 transition-colors duration-300">
                    {fabric.name}
                  </h3>

                  <ShoppingCart onClick={() => addItemToCart({ itemId: fabric._id, itemType: fabric.type, quantity : 1 })} />
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="bg-gradient-to-r from-green-500 to-green-600 text-white px-6 py-3 rounded-full hover:from-green-600 hover:to-green-700 transition-all duration-300 flex items-center space-x-2 shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
      ...
      <section className="relative py-20 bg-gradient-to-b from-white to-amber-50 overflow-hidden">
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <div className="mb-8">
            <Sparkles className="w-16 h-16 text-black mx-auto mb-6 opacity-90" />
          </div>
          ...
          <p className="text-xl text-amber-500 mb-10 max-w-3xl mx-auto leading-relaxed">
            Book a free home consultation to see these exquisite fabrics in your space with our expert guidance and personalized recommendations.
          </p>
