            ...
            <div className="space-y-4">
              <div className="flex flex-wrap space-x-4 space-y-3">
                <div className="flex items-center space-x-2">
                  <div
                    className="w-6 h-6 rounded-full border-2 border-white ring-2 ring-gray-300 shadow-sm"
                    style={{ backgroundColor: fabricData.color }}
                  />
                  <div>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-12 gap-2">
                ...
                <button
                  ...
                  onClick={() => handleNativeShare(fabricData)}
                >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button
                  className="bg-green-500 hover:bg-green-600 text-white py-2.5 px-4 rounded-xl flex items-center justify-center space-x-2 text-xs sm:text-sm"
                  onClick={() => handleWhatsAppQuote(fabricData)}
                >
                  <MessageCircle className="w-4 h-4" />
                  <span>Quote on WhatsApp</span>
                </button>
                <button
                  className="bg-gray-900 hover:bg-gray-800 text-white py-2.5 px-4 rounded-xl text-xs sm:text-sm"
            ...
            <div className="bg-white rounded-2xl shadow-lg p-4">
              ...
              <div className="grid grid-cols-1 gap-3 text-xs sm:text-sm">
                {featuresToShow.map((feature, i) => (
                  <div
                    key={i}
                    className="flex items-start space-x-2 bg-gray-50 p-2 rounded-lg hover:bg-gray-100 transition"
                  >
