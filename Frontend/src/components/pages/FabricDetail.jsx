          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <button className="bg-green-500 hover:bg-green-600 text-white py-2.5 px-4 rounded-xl flex items-center justify-center space-x-2 text-sm" onClick={() => handleWhatsAppQuote(fabricData)}>
                  <MessageCircle className="w-4 h-4" />
                  <span>Quote on WhatsApp</span>
                </button>
                <button className="bg-gray-900 hover:bg-gray-800 text-white py-2.5 px-4 rounded-xl text-sm" onClick={() => navigate("/book-demo")}>
                  Book Home Demo
                </button>
              </div>
            </div>
