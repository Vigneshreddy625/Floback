...
const FlolivaHomepage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden">
      ...
      <Header navItems={navItems} isScrolled={isScrolled} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} />
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto mt-6 sm:mt-0">
          <div className="space-y-4 md:space-y-8">
            ...
            <p className="text-xl md:text-2xl text-gray-200 max-w-3xl mx-auto leading-relaxed font-light">
              Where luxury meets functionality. Discover our curated collection of 
              <span className="text-yellow-400 font-semibold"> premium sofas</span>, 
              <span className="text-orange-400 font-semibold"> designer curtains</span>, and 
              <span className="text-pink-400 font-semibold"> bespoke furnishings</span>.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-6 justify-center pt-8">
              <button className="group relative px-10 py-5 bg-gradient-to-r from-yellow-400 to-orange-500 text-black font-bold rounded-2xl overflow-hidden transform hover:scale-105 transition-all duration-300 shadow-2xl shadow-yellow-500/25 hover:shadow-yellow-500/50" onClick={() => navigate("/shop")}>
              ...
              <button className="group px-10 py-5 bg-white/10 backdrop-blur-sm border-2 border-white/20 text-white font-bold rounded-2xl hover:bg-white/20 transition-all duration-300 transform hover:scale-105" onClick={() => navigate("/book-demo")}>
      ...
      <section className="py-8 md:py-16 bg-white">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-3 gap-3 lg:gap-8">
            {[
              { icon: Award, number: "500+", label: "Premium Designs", color: "from-yellow-400 to-orange-500" },
              { icon: Shield, number: "1 Year", label: "Warranty", color: "from-green-400 to-green-600" },
              { icon: Zap, number: "24/7", label: "Support", color: "from-purple-400 to-purple-600" }
            ].map((stat, index) => (
              <div key={index} className="text-center group">
                <div className={`w-16 h-16 bg-gradient-to-r ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-all duration-300 shadow-lg`}>
      ...
      <CollectionCard collections={collections} getFirstWordLower={getFirstWordLower}/>
